...
/**
 * It checks if the selected values are all true. <br>
 ...
 */
public final class IsAllTrueInMap<K> implements GiveableMapValidation<K, Boolean> {
	 ...
	 * @since 1.0.0
	 */
	public IsAllTrueInMap(final List<K> selectedKeys) {
