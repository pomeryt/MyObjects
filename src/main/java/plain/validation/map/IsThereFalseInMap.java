...
/**
 * It checks if false exists in selected keys. <br>
 ...
 */
public final class IsThereFalseInMap<K> implements GiveableMapValidation<K, Boolean> {
	 ...
	 * @since 1.0.0
	 */
	public IsThereFalseInMap(final List<K> selectedKeys) {
