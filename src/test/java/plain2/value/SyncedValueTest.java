...
class SyncedValueTest {
	...
	@Test
	void proveThreadSafetyByManipulatingNonThreadSafeList() throws InterruptedException {
		...
		this.addItemsInThreads(number, 200, latch);
		this.removeItemsInThreads(number, 100, latch);
		latch.await();
